...
public class inicioSesionAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vas a iniciar sesión como usuario administrador.");
    ...
    private void botonIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonIniciarSesionActionPerformed
        ...
        boolean entrado;
        try {
            //Busca el admin si existe, si no lo encuentra , no inicia sesion
            //Aun no le hemos puesto que avise al administrador si no lo encuentra.
            //Simplemente no ocurre nada
            entrado = g.buscarAdminPorNombreYContrasenia(contra, jtxtNombreUsuario.getText());
            if(entrado=true){
